...
class LLGApp {
  ...
  initLenis() {
    ...
    this.lenis = new Lenis({
      // 🎛️ LERP (Linear Interpolation) - Основная плавность скролла
      // 📊 Диапазон: 0.01 - 1.0
      // 🎯 0.01-0.05: Очень плавно, медленно (кинематографично)
      // 🎯 0.06-0.1: Плавно, контролируемо (рекомендуется)
      // 🎯 0.2-0.5: Быстро, отзывчиво (для интерактивных элементов)
      // 🎯 0.6-1.0: Мгновенно, без плавности (нативный скролл)
      // ⚡ Влияние: Чем меньше значение, тем плавнее анимация, но больше задержка
      lerp: 0.5,              // Плавно и контролируемо для премиум UX
      
      // 🖱️ WHEEL MULTIPLIER - Контроль скорости колеса мыши
      // 📊 Диапазон: 0.1 - 3.0
      // 🎯 0.1-0.3: Очень медленно (для детального контента)
      // 🎯 0.4-0.8: Умеренно (стандартная скорость)
      // 🎯 0.9-1.5: Быстро (для длинных страниц)
      // 🎯 1.6-3.0: Очень быстро (может быть неконтролируемо)
      // ⚡ Влияние: Множитель скорости прокрутки колесом мыши
      wheelMultiplier: 0.9,    // Замедлено в ~3 раза для точного контроля
      
      // 📱 TOUCH MULTIPLIER - Контроль скорости тач-скролла
      // 📊 Диапазон: 0.1 - 2.0
      // 🎯 0.1-0.4: Медленно (для точной навигации)
      // 🎯 0.5-0.8: Умеренно (баланс скорости и контроля)
      // 🎯 0.9-1.5: Быстро (нативная скорость)
      // 🎯 1.6-2.0: Очень быстро (может быть слишком резко)
      // ⚡ Влияние: Скорость свайпов на мобильных устройствах
      touchMultiplier: 0.9,    // Замедлено в 2 раза для мобильного UX
      
      // 🔄 SYNC TOUCH - Синхронизация тач-событий
      // 📊 Значения: true/false
      // 🎯 true: Синхронизирует тач с основным скроллом (рекомендуется)
      // 🎯 false: Независимая обработка тач-событий
      // ⚡ Влияние: Улучшает отзывчивость на мобильных устройствах
      syncTouch: true,         // Включить для лучшего мобильного опыта
      
      // 🎨 SYNC TOUCH LERP - Плавность тач-инерции
      // 📊 Диапазон: 0.01 - 0.3
      // 🎯 0.01-0.05: Очень плавная инерция (кинематографично)
      // 🎯 0.06-0.1: Плавная инерция (премиум ощущение)
      // 🎯 0.15-0.3: Быстрая инерция (отзывчиво)
      // ⚡ Влияние: Плавность затухания после тач-жестов
      syncTouchLerp: 0.05,     // Очень плавное затухание инерции
      
      // 🚀 TOUCH INERTIA MULTIPLIER - Сила инерции после свайпа
      // 📊 Диапазон: 5 - 50
      // 🎯 5-15: Слабая инерция (быстро останавливается)
      // 🎯 16-25: Умеренная инерция (контролируемо)
      // 🎯 26-35: Сильная инерция (стандарт Lenis)
      // 🎯 36-50: Очень сильная инерция (может быть неконтролируемо)
      // ⚡ Влияние: Как далеко прокручивается страница после свайпа
      touchInertiaMultiplier: 26, // Уменьшенная инерция для точного контроля
      
      // 🎮 VIRTUAL SCROLL - Кастомная обработка событий скролла
      // 📊 Функция получает объект события с deltaY (скорость скролла)
      // 🎯 deltaY > 100: Быстрый скролл (агрессивное замедление)
      // 🎯 deltaY 50-100: Средний скролл (умеренное замедление)  
      // 🎯 deltaY < 50: Медленный скролл (без изменений)
      // ⚡ Влияние: Адаптивное замедление предотвращает резкие прыжки
      // 💡 Пример: При быстрой прокрутке колесом скорость снижается на 70%
      virtualScroll: (e) => {
        // Адаптивное замедление в зависимости от скорости
        const speed = Math.abs(e.deltaY);
        if (speed > 100) {
          e.deltaY *= 0.3; // Агрессивное замедление быстрого скролла (70% снижение)
        } else if (speed > 50) {
          e.deltaY *= 0.6; // Умеренное замедление среднего скролла (40% снижение)
        }
        // Медленный скролл (< 50) остается без изменений для точности
      },
      
      // 📐 СТАНДАРТНЫЕ НАСТРОЙКИ LENIS
      
      // 🧭 ORIENTATION - Направление скролла
      // 📊 Значения: 'vertical', 'horizontal'
      // 🎯 'vertical': Вертикальный скролл (стандарт)
      // 🎯 'horizontal': Горизонтальный скролл
      // ⚡ Влияние: Определяет основное направление прокрутки
      orientation: 'vertical',
      
      // 👆 GESTURE ORIENTATION - Направление жестов
      // 📊 Значения: 'vertical', 'horizontal', 'both'
      // 🎯 'vertical': Только вертикальные жесты
      // 🎯 'horizontal': Только горизонтальные жесты  
      // 🎯 'both': Все направления жестов
      // ⚡ Влияние: Какие тач-жесты обрабатываются
      gestureOrientation: 'vertical',
      
      // 🎡 SMOOTH WHEEL - Плавность колеса мыши
      // 📊 Значения: true/false
      // 🎯 true: Плавная прокрутка колесом (рекомендуется)
      // 🎯 false: Нативная ступенчатая прокрутка
      // ⚡ Влияние: Включает/отключает сглаживание колеса мыши
      smoothWheel: true,
      
      // 🎬 AUTO RAF - Автоматический requestAnimationFrame
      // 📊 Значения: true/false
      // 🎯 false: Используем внешний ticker (GSAP) - РЕКОМЕНДУЕТСЯ
      // 🎯 true: Внутренний RAF Lenis (может конфликтовать с GSAP)
      // ⚡ Влияние: Контроль анимационного цикла для лучшей производительности
      autoRaf: false,          // Используем GSAP ticker для синхронизации
      
      // 🌊 OVERSCROLL - Эффект "резинки" на краях
      // 📊 Значения: true/false
      // 🎯 true: Разрешить прокрутку за пределы контента
      // 🎯 false: Жесткая остановка на краях
      // ⚡ Влияние: Естественное поведение как в нативном скролле
      overscroll: true,
      
      // ♾️ INFINITE - Бесконечный скролл
      // 📊 Значения: true/false
      // 🎯 false: Обычная страница с началом и концом (стандарт)
      // 🎯 true: Бесконечная прокрутка (специальные случаи)
      // ⚡ Влияние: Зацикливание контента при достижении краев
      infinite: false,
      
      // ⚓ ANCHORS - Поддержка навигации по якорям
      // 📊 Значения: true/false
      // 🎯 true: Поддержка #section-id навигации (КРИТИЧЕСКИ ВАЖНО!)
      // 🎯 false: Отключить якорную навигацию
      // ⚡ Влияние: Обязательно для SectionNavigation компонента
      // 🚨 ВНИМАНИЕ: Без этого не работает навигация по секциям!
    ...
    // 🚀 АДАПТИВНАЯ LERP СИСТЕМА - Динамическое изменение плавности
    // 📊 Скорость измеряется в единицах velocity (пиксели/кадр)
    // 🎯 velocity > 2: Быстрый скролл - максимальная плавность
    // 🎯 velocity 1-2: Средний скролл - умеренная плавность  
    // 🎯 velocity < 1: Медленный скролл - базовая плавность
    // ⚡ Влияние: Автоматически адаптирует плавность под скорость пользователя
    // 💡 Результат: Плавные переходы при быстром скролле, отзывчивость при медленном
    this.lenis.on('scroll', (e) => {
      const speed = Math.abs(e.velocity);
      
      // Динамическая адаптация lerp в зависимости от скорости скролла
      if (speed > 2) {
        // Быстрый скролл: максимальная плавность для кинематографичности
        this.lenis.options.lerp = 0.03; // Очень плавно (97% замедление)
      } else if (speed > 1) {
        // Средний скролл: умеренная плавность для баланса
        this.lenis.options.lerp = 0.04; // Плавно (96% замедление)
      } else {
        // Медленный скролл: базовая плавность для отзывчивости
        this.lenis.options.lerp = 0.05; // Умеренно плавно (95% замедление)
      }
    });
    
    // 🎬 GSAP TICKER INTEGRATION - Синхронизация с GSAP анимациями
    // 📊 Максимальная скорость ограничена значением 3 (пиксели/кадр)
    // 🎯 velocity > 3: Принудительное замедление на 20%
    // 🎯 velocity ≤ 3: Нормальная работа без ограничений
    // ⚡ Влияние: Предотвращает слишком быстрые прокрутки, которые могут сломать анимации
    // 💡 Результат: Стабильная работа ScrollTrigger и других GSAP компонентов
    gsap.ticker.add((time) => {
      // 🛡️ SPEED LIMITER - Ограничитель максимальной скорости
      // Защита от экстремально быстрых прокруток, которые могут:
      // - Сломать ScrollTrigger анимации
      // - Вызвать пропуски кадров
      // - Создать визуальные глитчи
      if (Math.abs(this.lenis.velocity) > 3) {
        this.lenis.velocity *= 0.8; // Принудительное замедление на 20%
      }
      
      // Передача времени в Lenis (конвертация в миллисекунды)
